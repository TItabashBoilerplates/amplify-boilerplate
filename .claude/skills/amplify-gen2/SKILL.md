...
| **Generative AI** — interactive **SSE streaming** (Hono streamSSE + Lambda RESPONSE_STREAM, LangChain/Bedrock); background agents (DB status + AppSync subscription); **>15min / sandboxed agents → Amazon Bedrock AgentCore** (Runtime/Code Interpreter) | [references/generative-ai.md](references/generative-ai.md) |
